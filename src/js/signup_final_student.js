...
// nn1r.K3t
        ...
        if (password_regex.test(password) && password == confirmpassword) {
            ...
            let password = document.getElementById("password").value;
                ...
                fetch('https://learnovate-backend.herokuapp.com/student/register', {
                method: 'POST',
                headers: {
                ...
                .then(function(res){
                    if(res.ok){
                        console.log("OK!");
                        console.log(res);
                        if(res.url = 'https://learnovate-backend.herokuapp.com/student/register'){
                            document.location.href = './Student Dashboard/index.html'
                        }
                    }else{
                        console.log("Not OK!!!");
                    }
