...
// nn1r.K3t
        ...
        if (password_regex.test(password) && password == confirmpassword) {
            ...
            let password = document.getElementById("password").value;
                ...
                fetch('https://learnovate-backend.herokuapp.com/instructor/register', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                  ...
                  "gender": "M",
                  "bio": "I am the smartest in the room"
                })
              })
                .then(function(res){
                    if(res.ok){
                        console.log("OK!");
                        console.log(res);
                        if(res.url = 'https://learnovate-backend.herokuapp.com/instructor/register'){
                            document.location.href = './Instructor Dashbord - updated/index.html'
                        }
                    }else{
                        console.log("Not OK!!!");
                    }
